            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <div class="flex flex-col md:flex-row items-center justify-between">
                    <div data-aos="zoom-in-right" class="md:w-5/12">
                        ...
                        <p class="text-gray-500 my-5 lg:pr-36">Skilline has got more than 100k positive ratings from our
                            users around
                            the world.</p>
                        <p class="text-gray-500 my-5 lg:pr-36">Some of the students and teachers were greatly helped by
                            the
                            Skilline.
                        </p>
                    ...
                    <div data-aos="zoom-in-left" class=" md:flex md:justify-center">
                        <div class="h-96 w-72 bg-red-400 rounded-xl relative">
                            <button type="button"
                                class="absolute top-0 -end-14 z-50 flex items-center justify-center h-full px-6 cursor-pointer group focus:outline-none"
                                data-carousel-next>
                                <span
